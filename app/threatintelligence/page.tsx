  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-4">
        ...
        <h1 className="text-2xl font-bold text-center mt-4">Threat Intelligence</h1>
          ...
          {catalogData.length === 0 && !loading ? (
            ...
            currentItems.map((dataset) => (
              <div key={dataset._id} className="border rounded-lg shadow-lg p-4 text-center">
                <h2 className="text-xl font-bold text-gray-700">{dataset.threatName}</h2>
                ...
                {expandedItem === dataset._id && (
                  <div className="mt-4 text-left bg-black-100 p-4 rounded">
                    ...
                    <ul className="list-disc list-inside">
                      ...
                      <li><strong>IOCS:</strong> {dataset.iocs}</li>
                      <li><strong>Threat Actors:</strong> {dataset.threatActors}</li>
                      <li><strong>Source:</strong> {dataset.source}</li>
                      <li><strong>Date Reported:</strong> {dataset.dateReported}</li>
                    </ul>
                  </div>
                )}
              </div>
